...
LastEditTime: 2022-11-20 15:40:20
FilePath: /ocean_change_python/GRACE_py/EWH.py
Description: calculate equivalent water height
...
def ocean_EWH(GSM_fold_path,GAX_fold_path, GAX_rankflag, institute_flag, res_lonlat, mask, love_path, degree1_path, c20_path, GIA_correction,lat_range=None):
    """计算EWH
    ...
    Lmax, _, _, SC, file_num = rsh.read_sh(
